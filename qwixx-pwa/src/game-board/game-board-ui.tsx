...
import { PossibleMoves } from '../hooks/use-global-game-state'
import { Board, Field, FieldSelection, FieldSelectionType, Line } from '../models/game'
...
export interface GameBoardUiProps {
  ...
  onToggleField: (line: Line, field: Field, type: FieldSelectionType) => void
}
...
export function GameBoardUi({
  ...
  function getSelectionType(line: Line, field: Field): FieldSelectionType | undefined {
  ...
  function checkIfDicesAllowMove(
    line: Line,
    field: Field,
  ...
  function handleFieldClick({ line, field }: BoardPosition) {
    ...
    onToggleField(line, field, selectionType)
  }
